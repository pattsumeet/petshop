window.CreateProductComponent = React.createClass({
    ...
    render : function() {
        ...
        */
        ...
        <div>
            {
                this.state.successCreation == "Pet was added." ?
            ...
            {
                this.state.successCreation == "Unable to add pet." ?
            ...
            <a href="#"
                ...
                className="btn btn-primary m-b-1em"> List of Pets
            </a>
